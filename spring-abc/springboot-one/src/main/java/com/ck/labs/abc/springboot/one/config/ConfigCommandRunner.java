...
public class ConfigCommandRunner implements CommandLineRunner,Ordered {

	@Override
	public void run(String... args) throws Exception {
		System.out.println("SpringApplication.run(SpringbootOneApplication.class, args)执行完成后，执行一次 order 1");
	}
