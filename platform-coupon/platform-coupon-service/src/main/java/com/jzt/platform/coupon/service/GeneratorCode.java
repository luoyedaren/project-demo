...
/**
 * project: wechat-root
 * Created by chenghai on 2018/6/19. - 星期二
 */
public class GeneratorCode {
	@Test
	public void generateCode() {
		//指定包名
		String packageName = "com.jzt.platform.coupon.service";
		//user -> UserService, 设置成true: user -> IUserService
		boolean serviceNameStartWithI = true;
		//指定生成的表名
//		String[] tableNames = new String[]{"member_info","wechat_info","rel_member_wechat","coupon_template","coupon_package","drugstore_balance","wechat_bill"};
		String[] tableNames = new String[]{"wechat_order"};
	...
	private GlobalConfig getGlobalConfig(boolean serviceNameStartWithI) {
		...
		globalConfig
				...
				.setAuthor("zjt")
				//设置输出路径
				.setOutputDir(getOutputDir("wechat-root"))
	...
	private DataSourceConfig getDataSourceConfig() {
		String dbUrl = "jdbc:mysql://10.3.5.45:6666/jzt_coupon";
		return new DataSourceConfig().setDbType(DbType.MYSQL)
				.setUrl(dbUrl)
				.setUsername("user_wechat")
				.setPassword("c7Hj9wJ7-21g2-1Ye8")
